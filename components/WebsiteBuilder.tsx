...
export const WebsiteBuilder: FC = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            const responseFiles = await geminiService.generateCodeProject(prompt, 'website', language);
    ...
    const handleEditSubmit = async (e: FormEvent) => {
        ...
        try {
            const responseFiles = await geminiService.editCodeProject(files, editInstruction, 'website', language);
            setFiles(responseFiles);
