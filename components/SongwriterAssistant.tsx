...
export const SongwriterAssistant: FC = () => {
  ...
  return (
    <div className="flex flex-col h-full animate-fade-in">
      <h2 className="text-2xl font-semibold mb-2 text-indigo-300">دستیار ترانه‌سرا</h2>
      <p className="mb-4 text-gray-400">ایده خود را برای آهنگتان توصیف کنید. می‌توانید درخواست شعر، آکورد، ساختار آهنگ یا ایده کلی بدهید.</p>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <textarea
          value={prompt}
          onChange={(e) => setPrompt(e.target.value)}
          placeholder="دستور خود را اینجا وارد کنید. برای مثال: یک شعر پاپ در مورد تابستان و دریا بنویس."
      ...
      <div className="flex-1 mt-6 flex flex-col overflow-hidden">
       ...
       <div className="flex items-center gap-2 p-2 mt-4 text-sm text-gray-400 bg-gray-800/50 rounded-lg border border-gray-700/50">
          ...
          <span>محدودیت استفاده (نمایشی): نامحدود (مشترک با تولید متن).</span>
        </div>
    </div>
  );
};